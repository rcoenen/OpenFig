...
function textOpts(el) {
  ...
  if (el.noWrap) {
    ...
    // Preserve the browser-measured text box when we already have one.
    // Letting Figma auto-grow multi-line text can collapse the intended
    // spacing to following siblings because the HTML stack relationship has
    // already been flattened into absolute positions by this handoff path.
    opts.autoresize = el.height ? 'NONE' : 'HEIGHT';
  }
  return opts;
}
