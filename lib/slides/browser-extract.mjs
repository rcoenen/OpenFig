      ...
      function walk(el) {
        ...
        if (tag === 'IMG') {
          ...
          if (src) {
            ...
            if (svgInline) {
              // @TODO: CSS filter on inline-SVG <img src="data:image/svg+xml;..."> is
              // not applied here — filters would need to be baked into the SVG markup
              // (e.g. invert fill/stroke colors directly). Out of scope for the raster
              // invert fix; revisit when a deck actually needs filtered inline SVGs.
