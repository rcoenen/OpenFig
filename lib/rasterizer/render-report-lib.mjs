...
export async function computeSsim(rendered, refPath, width, height) {
  // Auto-detect from reference image when no explicit size given
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .panel img{max-height:500px;max-width:100%;width:auto;height:auto;display:block;border:1px solid #333;border-radius:4px;cursor:zoom-in}
