...
function renderFrame(deck, node) {
  ...
  // frameMaskDisabled=false means "clip children to frame bounds" (Figma default).
  // This is how frames act as viewports — children outside the bounds are hidden.
...
function renderInstance(deck, node) {
  ...
  // Apply symbolOverrides (text characters, fill paints)
